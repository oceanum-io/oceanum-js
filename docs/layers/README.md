...
| ----------- | ----------------- | --------------- | --------------------------------------------------- |
| `magnitude` | `string`          | —               | Scalar variable name (or use `xvector` + `yvector`) |
| `xvector`   | `string`          | —               | X-component variable (alternative to `magnitude`)   |
| `yvector`   | `string`          | —               | Y-component variable (alternative to `magnitude`)   |
| `color`     | `[r,g,b]`         | `[200,200,200]` | Fallback colour when no colormap                    |
| `material`  | `boolean\|object` | `false`         | Phong material for lighting                         |

Provide either `magnitude` **or** (`xvector` + `yvector`).
...
| Prop                  | Type      | Default           | Description                                                  |
| --------------------- | --------- | ----------------- | ------------------------------------------------------------ |
| `xvector`             | `string`  | —                 | X (eastward) component variable                              |
| `yvector`             | `string`  | —                 | Y (northward) component variable                             |
| `magnitude`           | `string`  | —                 | Magnitude variable (alternative to xvector/yvector)          |
| `direction`           | `string`  | —                 | Direction variable (alternative to xvector/yvector)          |
| `speed`               | `number`  | `1.0`             | Animation speed multiplier                                   |
| `npart`               | `number`  | `1000`            | Number of particles                                          |
| `size`                | `number`  | `3`               | Particle size in pixels                                      |
| `length`              | `number`  | `12`              | Particle trail length                                        |
| `color`               | `[r,g,b]` | `[200,200,200]`   | Particle color                                               |
| `directionConvention` | `string`  | `'NAUTICAL_FROM'` | `'NAUTICAL_FROM'`, `'NAUTICAL_TO'`, or `'CARTESIAN_RADIANS'` |

Provide either (`xvector` + `yvector`) **or** (`magnitude` + `direction`).
...
| Prop                      | Type      | Default           | Description                       |
| ------------------------- | --------- | ----------------- | --------------------------------- |
| `xvector` / `yvector`     | `string`  | —                 | Vector component pair             |
| `magnitude` / `direction` | `string`  | —                 | Alternative vector pair           |
| `speed`                   | `number`  | `1.0`             | Animation speed multiplier        |
| `size`                    | `number`  | `3`               | Arrow size in pixels              |
| `color`                   | `[r,g,b]` | `[200,200,200]`   | Arrow color                       |
| `meshShape`               | `string`  | `'cone'`          | Mesh shape: 'cone', 'arrow', etc. |
| `meshLength`              | `number`  | `4`               | Mesh length multiplier            |
| `meshWidth`               | `number`  | `1`               | Mesh width multiplier             |
| `meshSize`                | `number`  | `1`               | Overall mesh size multiplier      |
...
| `color`      | `[r,g,b]`   | `[200,200,200]`     | Contour line color                                  |
...
| Prop              | Type           | Default                         | Description                                                                  |
| ----------------- | -------------- | ------------------------------- | ---------------------------------------------------------------------------- |
| `serviceUrl`      | `string`       | `https://layers.app.oceanum.io` | Root URL of the zarr service                                                 |
| `authHeaders`     | `object`       | `{}`                            | HTTP headers for authentication                                              |
| `layerId`         | `string`       | _required_                      | Dataset name (subpath of the service URL)                                    |
...
| `errorHandlers`   | `object`       | —                               | Error hooks object (see below)                                               |
...
The `errorHandlers` prop accepts per-state callbacks:
