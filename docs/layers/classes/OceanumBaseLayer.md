...
[@oceanum/layers](../README.md) / OceanumBaseLayer

# Class: OceanumBaseLayer

Defined in: [packages/layers/src/oceanum-base-layer.ts:135](https://github.com/oceanum-io/oceanum-js/blob/caaf80b4ce3f936efe18d2244930ed354860c5c1/packages/layers/src/oceanum-base-layer.ts#L135)
...
- [`OceanumPcolorLayer`](OceanumPcolorLayer.md)
- [`OceanumParticleLayer`](OceanumParticleLayer.md)
- [`OceanumPartmeshLayer`](OceanumPartmeshLayer.md)
- [`OceanumContourLayer`](OceanumContourLayer.md)

## Constructors

### Constructor

> **new OceanumBaseLayer**(...`propObjects`): `OceanumBaseLayer`
...
> **internalState**: `LayerState`\<`OceanumBaseLayer`\> \| `null`
...
Defined in: [packages/layers/src/oceanum-base-layer.ts:137](https://github.com/oceanum-io/oceanum-js/blob/caaf80b4ce3f936efe18d2244930ed354860c5c1/packages/layers/src/oceanum-base-layer.ts#L137)
...
> `static` **layerName**: `string` = `"OceanumBaseLayer"`

Defined in: [packages/layers/src/oceanum-base-layer.ts:136](https://github.com/oceanum-io/oceanum-js/blob/caaf80b4ce3f936efe18d2244930ed354860c5c1/packages/layers/src/oceanum-base-layer.ts#L136)
...
> **\_buildDatakeys**(`coordNames`): `ScalarDatakeys` \| `VectorDatakeys`

Defined in: [packages/layers/src/oceanum-base-layer.ts:261](https://github.com/oceanum-io/oceanum-js/blob/caaf80b4ce3f936efe18d2244930ed354860c5c1/packages/layers/src/oceanum-base-layer.ts#L261)
...
`ScalarDatakeys` \| `VectorDatakeys`

***

### \_createInnerLayer()

> **\_createInnerLayer**(`_slicedData`, `_datakeys`): `any`

Defined in: [packages/layers/src/oceanum-base-layer.ts:266](https://github.com/oceanum-io/oceanum-js/blob/caaf80b4ce3f936efe18d2244930ed354860c5c1/packages/layers/src/oceanum-base-layer.ts#L266)
...
`UpdateParameters`\<`OceanumBaseLayer`\>
...
> **\_validateVariableProps**(`_props`): `string` \| `null`

Defined in: [packages/layers/src/oceanum-base-layer.ts:257](https://github.com/oceanum-io/oceanum-js/blob/caaf80b4ce3f936efe18d2244930ed354860c5c1/packages/layers/src/oceanum-base-layer.ts#L257)
