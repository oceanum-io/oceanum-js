...
[@oceanum/layers](../README.md) / OceanumPartmeshLayer

# Class: OceanumPartmeshLayer

Defined in: packages/layers/src/oceanum-partmesh-layer.ts:30
...
> **new OceanumPartmeshLayer**(...`propObjects`): `OceanumPartmeshLayer`
...
> **internalState**: `LayerState`\<`OceanumPartmeshLayer`\> \| `null`
...
Defined in: packages/layers/src/oceanum-partmesh-layer.ts:32
...
Defined in: packages/layers/src/oceanum-partmesh-layer.ts:31
...
Defined in: packages/layers/src/oceanum-partmesh-layer.ts:47
...
Defined in: packages/layers/src/oceanum-partmesh-layer.ts:51
...
`UpdateParameters`\<`OceanumPartmeshLayer`\>
...
Defined in: packages/layers/src/oceanum-partmesh-layer.ts:34
